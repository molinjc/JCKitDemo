...
/** 对象方法的交换 */
inline void swizzledInstance(Class cls, SEL original, SEL swizzled) {
    Method originalMethod = class_getInstanceMethod(cls, original);
    Method swizzledMethod = class_getInstanceMethod(cls, swizzled);
    
    BOOL add = class_addMethod(cls, original, method_getImplementation(swizzledMethod), method_getTypeEncoding(swizzledMethod));
    if (add) {
...
inline void swizzledClass(Class cls, SEL original, SEL swizzled) {
